...
description: Configure Moonshot AI's language models in Roo Code. Access powerful AI models through Moonshot's OpenAI-compatible API.
keywords:
  - moonshot
  - moonshot ai
  - roo code
...
3.  **Create a Key:** Create a new API key. Give your key a descriptive name (e.g., "Roo Code").
